...
use path_input::PathCompletionCycle;
...
pub struct NewSessionDialog {
    ...
    /// State for cycling path autocomplete candidates with repeated Tab.
    path_completion_cycle: Option<PathCompletionCycle>,
}
