...
<div class="contributor-row">
  <div class="contributor-rank">-</div>
  <div class="contributor-info">
    <div class="contributor-name">Loading contributors...</div>
    <div class="contributor-stats">This page is generated at deploy time from the credit branch.</div>
  </div>
</div>
