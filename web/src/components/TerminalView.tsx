      ...
      <div className="flex-1 overflow-hidden bg-surface-950 relative">
        ...
        {state.isInScrollback && (
          <button
            ...
            className="absolute left-1/2 top-3 -translate-x-1/2 z-10 flex items-center gap-1.5 font-mono text-[12px] text-text-primary bg-surface-800/95 border border-surface-700 rounded-full px-3 py-1.5 shadow-lg backdrop-blur-sm active:scale-95 motion-safe:animate-[fadeIn_200ms_ease-out]"
          >
            <svg
              width="12"
              height="12"
