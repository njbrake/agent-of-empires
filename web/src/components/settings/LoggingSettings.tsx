...
const KNOWN_TARGETS: { value: string; group: string }[] = [
  ...
  { value: "cockpit.acp.spawn", group: "Cockpit" },
  { value: "cockpit.acp.wakeup", group: "Cockpit" },
  { value: "cockpit.acp.permission", group: "Cockpit" },
  { value: "cockpit.supervisor", group: "Cockpit" },
  { value: "cockpit.event_store", group: "Cockpit" },
  { value: "cockpit.runner", group: "Cockpit" },
  { value: "cockpit.ws", group: "Cockpit" },
  { value: "cockpit.client.ws", group: "Cockpit" },
  { value: "cockpit.push", group: "Cockpit" },
  { value: "cockpit.switch", group: "Cockpit" },
  { value: "cockpit.sandbox", group: "Cockpit" },
  // Terminal
  ...
  { value: "containers.exec", group: "Containers" },
  // Git
  { value: "git.command", group: "Git" },
  { value: "git.worktree", group: "Git" },
  { value: "git.template", group: "Git" },
  { value: "git.fetch", group: "Git" },
  // Web client (browser-side relay)
  { value: "web.client", group: "Web" },
  { value: "web.client.error", group: "Web" },
  { value: "web.client.api", group: "Web" },
  { value: "web.client.nav", group: "Web" },
  { value: "web.client.input", group: "Web" },
  { value: "web.client.settings", group: "Web" },
  { value: "web.client.ws", group: "Web" },
  { value: "web.client.terminal", group: "Web" },
  { value: "web.client.cockpit", group: "Web" },
  { value: "web.client.pwa", group: "Web" },
  // CLI subcommands
  { value: "cli.add", group: "CLI" },
  { value: "cli.serve", group: "CLI" },
  { value: "cli.session", group: "CLI" },
  { value: "cli.cockpit", group: "CLI" },
  { value: "cli.send", group: "CLI" },
  { value: "cli.list", group: "CLI" },
  { value: "cli.project", group: "CLI" },
  { value: "cli.init", group: "CLI" },
  { value: "cli.logs", group: "CLI" },
  { value: "cli.log_level", group: "CLI" },
  // TUI
  { value: "tui.input", group: "TUI" },
  { value: "tui.navigation", group: "TUI" },
  { value: "tui.render", group: "TUI" },
  { value: "tui.dialog", group: "TUI" },
  { value: "tui.settings", group: "TUI" },
  { value: "tui.home", group: "TUI" },
  { value: "tui.cockpit", group: "TUI" },
  // Session lifecycle
  { value: "session.create", group: "Session" },
  { value: "session.delete", group: "Session" },
  { value: "session.group", group: "Session" },
  { value: "session.profile", group: "Session" },
  { value: "session.capture", group: "Session" },
  { value: "session.heartbeat", group: "Session" },
  { value: "session.store", group: "Session" },
  // tmux integration
  { value: "tmux.command", group: "Tmux" },
  { value: "tmux.cache", group: "Tmux" },
  { value: "tmux.status", group: "Tmux" },
  { value: "tmux.pane", group: "Tmux" },
  // HTTP REST surface
  { value: "http.request", group: "HTTP" },
  { value: "http.middleware", group: "HTTP" },
  { value: "http.error", group: "HTTP" },
  { value: "http.api.sessions", group: "HTTP" },
  { value: "http.api.projects", group: "HTTP" },
  { value: "http.api.settings", group: "HTTP" },
  { value: "http.api.git", group: "HTTP" },
  { value: "http.api.system", group: "HTTP" },
  { value: "http.api.log_level", group: "HTTP" },
  { value: "http.api.client_log", group: "HTTP" },
  // serve daemon lifecycle
  { value: "serve.daemon", group: "Serve" },
